...
norm_mrsi_us_train = mrsi_us_train# / mrsi_fs_train.abs().max()
...
modelname=f"No_Norm_LR_mrsi_bs500_bpe2_snrNone_lr_0.0001"
...
#torch.save(mrsi_recons, "norm_mrsi_recons.pt")
#exit()
